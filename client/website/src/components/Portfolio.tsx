    ...
    <section id="portfolio" className="relative bg-slate-50/60 py-12 sm:py-16">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          ...
          <div className="flex items-center gap-2 rounded-xl bg-white p-2 shadow-xs border border-slate-200/80">
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                <Link href={`/portfolio/${project.id}`}>
                  <h3 className="text-lg font-bold text-[#0f172a] transition-colors group-hover:text-blue-600">
                    {project.title}
                  </h3>
                </Link>
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
                  <Link
                    href={`/portfolio/${project.id}`}
                    className="group/btn inline-flex items-center justify-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2.5 text-xs sm:text-sm font-semibold text-white shadow-sm shadow-blue-600/20 transition-all duration-200 hover:bg-blue-700 hover:shadow-md hover:shadow-blue-600/30 active:scale-[0.98]"
                  >
